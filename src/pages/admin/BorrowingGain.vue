...
function initTableData() {
    ...
    renderData(`/admin/Api/bookLoan/getList?limit=${toolInfo.limit}&page=${toolInfo.page}&search=${toolInfo.search}`)
}
...
<template>
    <div class="tableMain">
        ...
        <el-table ref="multipleTableRef" :data="data" v-zyloading="store.tableLoading" row-class-name="tableLzy" stripe
            :size="store.isMobile ? 'small' : 'large'" style="width: 100%;height:750px">
            <el-table-column prop="loanId" label="借阅id" width="80px" />
            <el-table-column prop="bookName" label="图书名称" :show-overflow-tooltip="{ placement: 'bottom' }" />
